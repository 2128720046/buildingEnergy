...
export default function EnergyTwinDashboard({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-20 overflow-hidden text-slate-100">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_45%,rgba(0,229,255,0.08),rgba(5,5,5,0.76)_52%,rgba(3,7,16,0.95)_100%)]" />
      ...
      <section
        className="absolute inset-x-0 top-[10vh] bottom-0 z-20 grid gap-4 px-4 py-4"
        style={{
