...
// within ~80ms. Speeds up t-junction drags ~3×, 4-corner-room drags ~4×.
...
export const WallSystem = () => {
  ...
  useFrame(() => {
    ...
    for (const [levelId, dirtyWallIds] of dirtyWallsByLevel) {
      ...
      // Rebuild dirty walls immediately — no throttling. The dragged wall
      // must follow the cursor with full fidelity.
