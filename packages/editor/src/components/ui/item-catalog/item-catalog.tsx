...
import { localizeDisplayName, localizeTag } from './../../../lib/zh-cn'
          ...
          return (
            <Tooltip key={index}>
              <TooltipTrigger asChild>
                ...
                >
                  <Image
                    alt={localizeDisplayName(item.name)}
                  ...
                  {attachmentIcon && (
                    <div className="absolute right-0.5 bottom-0.5 flex h-4 w-4 items-center justify-center rounded bg-black/60">
                      <Image
                        alt={item.attachTo === 'ceiling' ? '天花挂载' : '墙面挂载'}
                        className="h-4 w-4"
                        height={16}
                        src={attachmentIcon}
                        width={16}
